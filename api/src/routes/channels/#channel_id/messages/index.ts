...
import { handleMessage, postHandleMessage, route } from "@copycord/api";
...
router.get("/", async (req: Request, res: Response) => {
	...
	return res.json(
		messages.map((x: any) => {
			...
			// @ts-ignore
			if (!x.author) x.author = { id: "4", discriminator: "0000", username: "copycord Ghost", public_flags: "0", avatar: null };
