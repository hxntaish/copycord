...
export interface ConfigValue {
	...
	api: {
		...
		usecopycordEnhancements: boolean;
	};
	general: {
		instanceName: string;
...
export const DefaultConfigOptions: ConfigValue = {
	...
	api: {
		...
		usecopycordEnhancements: true,
	},
	general: {
		instanceName: "copycord Instance",
		instanceDescription: "This is a copycord instance made in pre-release days",
		frontPage: null,
		tosPage: null,
