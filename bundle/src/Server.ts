...
import * as Api from "@copycord/api";
import * as Gateway from "@copycord/gateway";
import { CDNServer } from "@copycord/cdn";
import express from "express";
import { green, bold, yellow } from "picocolors";
import { Config, initDatabase } from "@copycord/util";
...
// @ts-ignore
const api = new Api.copycordServer({ server, port, production, app });
// @ts-ignore
